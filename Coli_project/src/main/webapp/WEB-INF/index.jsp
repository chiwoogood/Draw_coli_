                                      ...
                                      <article class="post-item">
                                          <figure>
                                             ...
                                             <c:when test="${not empty article.articleFiles}">
                                              ...
                                              <img src="${cpath}/uploadFile/${fileName}" alt="post" class="post-image" onerror="handleImageError(this, '${cpath}/images/default.png')">
                                          </c:when>
                                             <c:otherwise>
                                                 <%-- 파일이 없는 경우 기본 이미지 사용 --%>
                                          ...
                                          <div class="post-content">
                                              ...
                                              <h3 class="post-title"><a href="#">${article.atc_title}</a></h3>
